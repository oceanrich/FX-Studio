...
export default function Contact() {
  ...
  return (
    <main className="pt-16 md:pt-20">
      <section className="min-h-screen py-20 md:py-32 px-4 sm:px-6 lg:px-12 bg-white">
        <div className="max-w-3xl mx-auto text-center space-y-10 md:space-y-12">
          ...
          {/* Contact Info */}
          <div className="pt-8 md:pt-12 space-y-6 md:space-y-8 text-base md:text-lg text-gray-700">
            <p className="px-4">{t.contact.description}</p>
            
            <div className="pt-8 md:pt-12 space-y-4 md:space-y-6 max-w-lg mx-auto px-4">
              {/* Email */}
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 md:gap-4 p-4 md:p-6 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                ...
                <div className="flex-grow min-w-0">
                  <p className="text-xs md:text-sm text-gray-500 mb-1">{t.contact.email}</p>
                  <a 
                    href="mailto:aaronshue73@outlook.com"
                    className="text-base md:text-lg font-medium text-black hover:text-gray-600 transition-colors break-all"
                  >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 md:gap-4 p-4 md:p-6 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                <div className="flex-shrink-0 self-start sm:self-center">
                  <svg className="w-9 h-9 md:w-10 md:h-10 text-gray-700" fill="currentColor" viewBox="0 0 1024 1024">
                ...
                <div className="flex-grow">
                  <p className="text-xs md:text-sm text-gray-500 mb-1">{t.contact.wechat}</p>
